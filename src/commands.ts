...
import { changeModel, selectAnthropicModel, selectOpenAIModel, selectDeepseekModel, changeMaxTokens } from './configurationCommands';
...
export function activate(context: vscode.ExtensionContext) {
    context.subscriptions.push(
        ...
        vscode.commands.registerCommand('ai-coder.selectDeepseekModel', selectDeepseekModel),
